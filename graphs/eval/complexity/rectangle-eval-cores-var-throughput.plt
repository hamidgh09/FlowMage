...
### Input file
baseline_file = "csvs/defaultF_RX_PPS.csv"
ref_file = "csvs/optimizedF_RX_PPS.csv"
ref2_file = "csvs/not-optimizedF_RX_PPS.csv"
y_scale=1
...
set output 'eval-complexity-optimizer.pdf'
...
plot ref_file using ($5/1000000):xtic(1) ls 1 title "FlowMage - CCE on", \
ref2_file using ($5/1000000) with histogram ls 2 title "FlowMage - CCE off", \
